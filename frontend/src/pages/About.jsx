    ...
    <div className='bg-white'>
        <h1 className=" h-[300px] text-white font-bold md:text-4xl text-2xl  md:p-[70px] p-[80px] mx-auto " style={{ backgroundImage: `url(${abtt})`, backgroundSize: 'cover', backgroundPosition: 'center', }}>
            ...
            <div className='border-2 border-orange-200'>
                <h1 className='text-center bg-orange-300  border-2 border-orange-200 w-[500px] mt-8 text-2xl mx-auto'>Our fundamental identity revolves around continual growth, 
            ...
            <div className='mt-9 lg:flex-row-reverse lg:flex space-y-7 p-3'>
                ...
                <div>
                <h1 className='p-3 w-[300px] mx-auto text-2xl text-center font-bold border-2 border-orange-200  bg-orange-300'>Our Values</h1>
                <p className='p-3 md:p-6' ><span className='font-bold'>Embrace</span> innovation to surpass anticipated outcomes.
                    ...
                    Cultivate connections to provide long-lasting value.
                    Demonstrate expertise to pioneer our industry's advancement.
                    Act in the best interest of our clients, employees, and communities.</p>
                </div>
            </div>
    </div>
