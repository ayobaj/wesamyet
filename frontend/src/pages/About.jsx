    ...
    <div className='bg-white'>
        <h1 className=" h-[300px] text-white font-bold md:text-4xl text-2xl  md:p-[70px] p-[80px] mx-auto " style={{ backgroundImage: `url(${abtt})`, backgroundSize: 'cover', backgroundPosition: 'center', }}>
            ...
            <div className=' border-orange-200'>
                <h1 className='text-center bg-orange-300  border-orange-200 sm:w-[500px] mt-8 text-2xl mx-auto'>Our fundamental identity revolves around continual growth, 
                    <br/>flexibility, and expediting achievement.</h1>


                    <p className='p-1 pt-5 md:p-6'>Providing insightful guidance to tenants, proprietors, and investors propels the real estate sector forward.
            ...
            <div className='mt-9 lg:flex-row-reverse lg:flex space-y-7 p-3'>
                ...
                <div>
                <h1 className='p-3 sm:w-[300px] mx-auto text-2xl text-center font-bold border-orange-200  bg-orange-300'>Our Values</h1>
                <p className='p-1 md:p-6' ><span className='font-bold'>Embrace</span> innovation to surpass anticipated outcomes.
